...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Kiddie Kingdom!</h1>
                    <p>Fueling Fun for Every age!</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/mc.jpg" alt="Lightning Mcqueen">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/js.jpeg" alt="Jackson Storm">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Jackson Storm</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/hh.jpeg" alt="Hudson Hornet">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Hudson Hornet</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/tm.jpg" alt="Tow Mater">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Tow Mater</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sherif.jpg" alt="sherif">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>SherifF</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/francesco.png" alt="francesco">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Francesco </h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/cd.jpg" alt="Cute Dinosaur">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cute Dinosaur</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/bt.webp" alt="Bubble Tea">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Bubble Tea</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/p.jpg" alt="Sleeping Penguin">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sleeping Penguin</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/a.jpeg" alt="Avocado">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Avocado</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/im.jpg" alt="Iron Man">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Iron Man</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/aa.webp" alt="Captain America">
                            </a>
                            <center>
                                <div class="caption">
